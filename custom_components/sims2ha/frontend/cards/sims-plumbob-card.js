...
class SimsPlumbobCard extends LitElement {
  ...
  render() {
    ...
    this.style.setProperty(
      "--plumbob-face-top",
      this.getFaceTopColor(plumbobColor),
    );
    this.style.setProperty(
      "--plumbob-face-bottom",
      this.getFaceBottomColor(plumbobColor),
    );
  ...
  getFaceTopColor(color) {
    switch (color) {
      case "green":
        return "rgba(123,201,66,0.3)";
      case "red":
        return "rgba(192,57,43,0.3)";
      case "yellow":
        return "rgba(242,193,78,0.3)";
      case "blue":
        return "rgba(47,134,197,0.3)";
      case "orange":
  ...
  getFaceBottomColor(color) {
    switch (color) {
      case "green":
        return "rgba(123,201,66,0.4)";
      case "red":
        return "rgba(192,57,43,0.4)";
      case "yellow":
        return "rgba(242,193,78,0.4)";
      case "blue":
        return "rgba(47,134,197,0.4)";
      case "orange":
